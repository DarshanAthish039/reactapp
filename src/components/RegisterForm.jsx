  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        localStorage.setItem("donors", JSON.stringify([...existingDonors, donorData]));
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="mb-3">
                  <label htmlFor="bloodGroup" className="form-label">
                    <FaTint className="me-2" /> Blood Group
                  </label>
                  <select
                ...
                <div className="mb-3">
                  <label htmlFor="referredBy" className="form-label">
                    <FaIdCard className="me-2" /> Referral Code (Optional)
                  </label>
                  <input
                    type="text"
                ...
                <div className="d-grid mb-3">
                  <button type="submit" disabled={isSubmitting} className="btn btn-danger btn-lg">
